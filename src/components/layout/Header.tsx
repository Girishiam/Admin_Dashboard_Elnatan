...
const ALL_NOTIFICATIONS = [
  {
    ...
    body: 'Olivia Smith placed an order for $120.50',
    time: '10 minutes ago',
    unread: true,
  },
  {
    ...
    body: 'Transaction TX-004 to Emma Brown failed',
    time: '1 hour ago',
    unread: true,
  },
  {
    ...
    body: 'Liam Johnson\'s order TX-001 has been delivered',
    time: '3 hours ago',
    unread: false,
  },
  {
    ...
    body: 'Product "ADHD Planner Vol.2" is running low (3 left)',
    time: '5 hours ago',
    unread: false,
  },
  {
    ...
    iconBg: 'bg-blue-100 text-blue-600',
    title: 'New Order Placed',
    body: 'Noah Williams placed an order for $95.00',
  ...
  },
  {
    ...
    body: 'Payment of $350.00 received from Liam Johnson',
  ...
  },
  {
    ...
    body: 'Order TX-002 from Olivia Smith is still pending',
    time: '2 days ago',
    unread: false,
  },
];

const PREVIEW_NOTIFICATIONS = ALL_NOTIFICATIONS.slice(0, 2);
const UNREAD_COUNT = ALL_NOTIFICATIONS.filter(n => n.unread).length;
